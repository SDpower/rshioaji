...
# 啟用高效能功能 (推薦)
rshioaji = { version = "0.4.8", features = ["speed"] }
...
## 🎯 新功能 v0.4.8 - 市場資料結構完全相容性與程式碼品質提升

### 重大變更說明 (從 v0.2.0 跳躍至 v0.4.8)

由於 v0.2.0 版本在功能實現上存在問題，我們進行了大幅度的架構重構和功能完善：

- **❌ v0.2.0 問題**：回調系統未完全實現，市場資料訂閱存在問題
- **✅ v0.4.8 成果**：完全相容的市場資料結構，修正 DateTime 欄位，零程式碼警告
- **🚀 跳躍版本**：反映重大架構改進和功能完整性
...
# 添加依賴
echo 'rshioaji = { version = "0.4.8", features = ["speed"] }' >> Cargo.toml
