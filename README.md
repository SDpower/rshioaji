...
# 啟用高效能功能 (推薦)
rshioaji = { version = "0.4.7", features = ["speed"] }
...
## 🎯 新功能 v0.4.7 - 完整實現市場資料訂閱與回調系統

### 重大變更說明 (從 v0.2.0 跳躍至 v0.4.7)

由於 v0.2.0 版本在功能實現上存在問題，我們進行了大幅度的架構重構和功能完善：

- **❌ v0.2.0 問題**：回調系統未完全實現，市場資料訂閱存在問題
- **✅ v0.4.7 成果**：完整實現 Python → Rust 回調轉發，成功接收真實市場資料
- **🚀 跳躍版本**：反映重大架構改進和功能完整性
...
# 添加依賴
echo 'rshioaji = { version = "0.4.7", features = ["speed"] }' >> Cargo.toml
